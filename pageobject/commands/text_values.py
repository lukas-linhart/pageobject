...
def text_values(self):
    ...
    :rtype: list of str
    """
    self.logger.info('getting children text values of page object list; {}'.format(self._log_id_long))
    values = [child.text for child in self.children]
    self.logger.info('children text values of page object list are: {}; {}'.format(values, self._log_id_long))
    return values
